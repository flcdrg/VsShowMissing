...
using DavidGardiner.Gardiner_VsShowMissing;

namespace Gardiner.VsShowMissing_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new Gardiner_VsShowMissingPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(DavidGardiner.Gardiner_VsShowMissing.GuidList.guidGardiner_VsShowMissingCmdSet, (int)DavidGardiner.Gardiner_VsShowMissing.PkgCmdIDList.cmdidFindMissingFiles);
